...
class LeRobotDataset(torch.utils.data.Dataset):
    ...
    def load_hf_dataset(self) -> datasets.Dataset:
        ...
        if self.episodes is None:
            ...
            fpaths = [str(self.root / self.meta.get_data_file_path(ep_idx)) for ep_idx in list(range(self.meta.total_episodes))]
            hf_dataset = load_dataset("parquet", data_files=fpaths, split="train", num_proc=8)
        else:
